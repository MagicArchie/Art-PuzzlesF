...
function draw() {
  ...
  fill(200, 50);
  rect(rectX1, height * 0.855, rectWidth1, height * 0.1, 300); // Update the width and height of the rectangle to match the canvas size
  ...
  fill(200, 200);
  rect(rectX2, height * 0.62, rectWidth2, height * 0.2, 20); // Update the width and height of the rectangle to match the canvas size
