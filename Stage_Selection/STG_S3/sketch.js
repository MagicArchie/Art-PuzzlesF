...
function preload() {
  ...
  for (let i = 0; i < stageCount; i++) {
    const imagePath = `materials/images/Stg_${i + 1}C.png`;
    try {
...
function setup() {
  ...
  for (let i = 0; i < stageCount; i++) {
    ...
    stages.push({
      ...
      interactive: i < 3 // Set interactivity to true for the first three nodes, false for others
    });
  }
...
// Example: To turn off interactivity for all nodes except the first three
